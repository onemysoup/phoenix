...
export class WeightStore {
     ...
     */
    learn(domain, correctSignalBreakdown, tier2TopScores, correctElementIndex) {
        // Find where the correct element ranked in Tier 2
        const correctRank = tier2TopScores.findIndex(s => s.index === correctElementIndex);
        if (correctRank <= 0)
            return []; // Tier 2 already found it or not in candidates
...
//# sourceMappingURL=weight-store.js.map