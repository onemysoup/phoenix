...
function configNumber(name, fallback, min = 0) {
...
class GeminiProvider {
    ...
    async chat(messages, options) {
        ...
        const resp = await fetchWithTimeout(`https://generativelanguage.googleapis.com/v1beta/models/${this.model}:generateContent?key=${this.apiKey}`, {
            method: "POST",
